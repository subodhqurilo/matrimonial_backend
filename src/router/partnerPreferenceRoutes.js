...
import { createOrUpdatePartnerPreference, getPartnerPreference, getSearchUserById, searchUsers,getUsersByPreference } from '../controller/partnerPreferenceController.js';
...
partnerRoute.get('/matchedProfiles', authenticateUser, getUsersByPreference);
